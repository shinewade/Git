...
public class SCAN_TM extends TestMethod {

    @In public String spec_measurement;
    @In public String spec_measurement1;
    @In public String ComparePinList;
    @In public int    period_ns;
    @In public int    strobe_ns;
    public IMeasurement measurement;
    public ILocalMeasurement measurement1;

    public IParametricTestDescriptor ptd_SCAN;
    ...
    public void setup ()
    {
        ...
        i2c.transactionSequenceBegin("scan_Mode");
            i2c.write(BesI2cAddrType.PMUIntern, 0x14,0x4e79);//0x4000 ldo, 0x4e79 dcdc
        ...
        pattern1="vectors.pattern_dft.bt1502x_verA_20211228_prod_scan_stuck__0_13000_rev1p0_ascii";
...
//        res1.writeFailLog2Text(ComparePinList, 10000,"failLog_Scan_Stuck");//TBD
