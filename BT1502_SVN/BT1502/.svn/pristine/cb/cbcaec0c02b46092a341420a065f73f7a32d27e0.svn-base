...
public class read_all_register extends TestMethod {
    ...
    //RF
    @In public int[] startRegAddr_RF  ={0x00 ,0x101  };//page0, page1, page...
    @In public int[] stopRegAddr_RF   ={0xEA ,0x188  };//page0, page1, page...
    ...
    public void setup () {
        ...
        BesPA_I2C i2c;
        if(isRegAddr16Bits) {
            i2c=new BesPA_I2C(ds1, measurement, I2cRegAddrBits.RegAddr_16Bits);
        }
        else {
