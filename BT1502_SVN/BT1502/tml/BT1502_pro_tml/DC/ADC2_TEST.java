...
public class ADC2_TEST extends TestMethod {
    ...
    public IParametricTestDescriptor ptd_adc2_sense;
    ...
    public void setup()
    {
        ...
        DigInOut_ADC0.vforce("Vforce_1V_ADC0").setForceValue("1.0 V").setIrange("56 mA").setIclamp("56 mA");
        ...
        i2c.transactionSequenceBegin("ADC0_TEST");
            ...
            i2c.write(BesI2cAddrType.PMUIntern, 0x1d,0x2710);
            i2c.write(BesI2cAddrType.PMUIntern, 0x4f,0x0e24);
            i2c.waitTime(5e6);
            i2c.read(BesI2cAddrType.PMUIntern, 0x5a,"readValue_0x58");//ch2 ADC0
