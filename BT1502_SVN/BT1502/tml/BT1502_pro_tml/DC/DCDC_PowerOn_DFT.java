...
public class DCDC_PowerOn_DFT extends TestMethod {
...
//            i2c.write(BesI2cAddrType.PMUIntern,0xc3,0x8484);//vcodec    0x9191
    ...
    public void execute() {
        ...
        calData_Vcore.set( StaticFields.cal_Shift_Vcore_DFT.add(StaticFields.cal_Shift_Vcore_DFT.leftShift(8)).add(StaticFields.regValue_DCBuck_Vcore_DFT)  );
        ...
        if(dcdc_meas) {
            ...
            println("StaticFields.vcore_DFT_v  = "+StaticFields.vcore_DFT_v);
            ...
            for(int site:activeSites) {
                println("site= "+site+" data_Vcore: 0x"+Long.toHexString(StaticFields.regValue_DCBuck_Vcore_DFT.get(site)));
