...
public class Init_variables extends TestMethod {
    ...
    public void setup() {
        ...
        BesPA_I2C.setI2CPageAddress(BesI2cAddrType.RF, 0x00);
        BesPA_I2C.setI2CPageAddress(BesI2cAddrType.PMU, 0x00);
        BesPA_I2C.setI2CPageAddress(BesI2cAddrType.ANA, 0x60);
        ...
        case "V085":
            ...
            break;
        case "V087":
            StaticFields.regValue_DCBuck_Vcore_DFT.set(0x9797);
            StaticFields.Vcore_DFT_DCBuck_Cal.set(0.87);
            break;
        case "V0746":
        ...
        case "V070":
            ...
            break;
        default:
            throw new DeviceSetupUncheckedException("vcore_dft_v= "+StaticFields.vcore_DFT_v+" is not defined in test program! ");
        }
