...
/**
 * This class is used to calculate BES BT RX parameter
 * @version V1.1
 * @author Ronnie Li, Weng Yongxin
 **/
public class BesCalc_BTRX{
     ...
     */
    public BesCalc_BTRX(MultiSiteWaveDouble capWaveI, MultiSiteWaveDouble capWaveQ, int signalBinCount, double noiseStartFrequency, double noiseStopFrequency) {
...
//            this.noiseStopFrequency=this.n_I.get(activeSites[0])/2;
    ...
    /**
     * calculate noise power I.
     * @return RX noise power I in unit dBm.
     */
    public MultiSiteDouble getRXPowerNoise_I_dBm() {
        return this.PowNor_I.subtract(this.PowSig_I).log10().multiply(10);
    }

    /**
     * calculate noise power Q.
     * @return RX noise power Q in unit dBm.
     */
    public MultiSiteDouble getRXPowerNoise_Q_dBm() {
        return this.PowNor_Q.subtract(this.PowSig_Q).log10().multiply(10);
    }
